...
class yoloDataset(object):
	"""docstring for yoloDataset"""
	def __init__(self,common_params,dataset_params,file,train=True):
		...
		fs_input = tf.gfile.GFile(self.file,'r')
...
if __name__=='__main__':
	dataset = yoloDataset(cfg.common_params,cfg.dataset_params)
	for i in range(100):
