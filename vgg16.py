...
class Vgg16(object):
	...
	def get_conv_var(self, filter_size, in_channels, out_channels, name):
		...
		weight_decay = tf.multiply(tf.nn.l2_loss(filters),5e-4,name='weight_loss')
		tf.add_to_collection('losses',weight_decay)

		bias_decay = tf.multiply(tf.nn.l2_loss(biases),5e-4,name='bias_loss')
